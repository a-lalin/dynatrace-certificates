...
> A service occurs when a process or group of processes manages a request, indicating that a particular task needs to be completed, and a process takes action to fulfill it.
